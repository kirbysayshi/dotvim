...
" custom markdown rules to match textmate
hi markdownH1 ctermfg=231 ctermbg=NONE cterm=bold guifg=#ffe2d1 guibg=#783b0f gui=bold
hi markdownH2 ctermfg=231 ctermbg=NONE cterm=bold guifg=#ffe2d1 guibg=#783b0f gui=bold
hi markdownH3 ctermfg=231 ctermbg=NONE cterm=bold guifg=#ffe2d1 guibg=#783b0f gui=bold
hi markdownH4 ctermfg=231 ctermbg=NONE cterm=bold guifg=#ffe2d1 guibg=#783b0f gui=bold
hi markdownH5 ctermfg=231 ctermbg=NONE cterm=bold guifg=#ffe2d1 guibg=#783b0f gui=bold
hi markdownH6 ctermfg=231 ctermbg=NONE cterm=bold guifg=#ffe2d1 guibg=#783b0f gui=bold
hi markdownHeadingDelimiter ctermfg=231 ctermbg=NONE cterm=bold guifg=#ffe2d1 guibg=#783b0f gui=bold
hi markdownItalic ctermfg=231 ctermbg=NONE cterm=NONE guifg=#eec97f guibg=NONE gui=italic
hi markdownBold ctermfg=231 ctermbg=NONE cterm=NONE guifg=#eec97f guibg=NONE gui=bold
hi markdownBoldItalic ctermfg=231 ctermbg=NONE cterm=NONE guifg=#eec97f guibg=NONE gui=bold,italic
hi markdownCodeDelimiter ctermfg=231 ctermbg=NONE cterm=NONE guifg=#679ebe guibg=NONE gui=NONE
hi markdownCode ctermfg=231 ctermbg=NONE cterm=NONE guifg=#679ebe guibg=NONE gui=NONE
hi markdownCodeBlock ctermfg=231 ctermbg=NONE cterm=NONE guifg=#679ebe guibg=NONE gui=NONE
hi markdownLinkText ctermfg=231 ctermbg=NONE cterm=NONE guifg=#6cb252 guibg=NONE gui=NONE
hi markdownListMarker ctermfg=231 ctermbg=NONE cterm=NONE guifg=#e7dbc7 guibg=NONE gui=NONE
hi markdownOrderedListMarker ctermfg=231 ctermbg=NONE cterm=NONE guifg=#e7dbc7 guibg=NONE gui=NONE
hi markdownUrl ctermfg=173 ctermbg=NONE cterm=NONE guifg=#ea9a7b guibg=NONE gui=NONE
